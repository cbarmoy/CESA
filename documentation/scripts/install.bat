@echo off
REM ========================================
REM   CESA v0.0beta1.1 - Script d'installation
REM ========================================
REM
REM Script d'installation des dépendances pour CESA (Complex EEG Studio Analysis) v0.0beta1.1
...
echo ========================================
echo   CESA v0.0beta1.1 - Installation
echo ========================================
echo.
