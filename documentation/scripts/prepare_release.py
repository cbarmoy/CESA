#!/usr/bin/env python3
"""
CESA 0.0beta1.0 - Release Preparation Script
=============================================

Script de préparation de la release CESA (EEG Studio Analysis) 0.0beta1.0.
...
def generate_changelog():
    ...
    try:
        ...
        try:
            ...
            git_info = "\n### 📊 Historique\n- Publication 0.0beta1.0 - Première pré-release publique"

        changelog = f"""# CESA 0.0beta1.0 - Changelog
Généré le {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}

## Version 0.0beta1.0 - Première pré-release
...
- Initialisation Git (`main` + tag `v0.0beta1.0`)
...
---
**CESA (Complex EEG Studio Analysis) 0.0beta1.0**  
...
def prepare_release() -> bool:
    ...
    print("🚀 CESA 0.0beta1.0 - Préparation de la release")
    print("=" * 60)
    ...
    if all_success:
        ...
        print("   3. Créer le tag Git: git tag -a v0.0beta1.0 -m 'Pre-release 0.0beta1.0'")
