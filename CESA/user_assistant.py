"""
CESA (EEG Studio Analysis) v3.0 - Assistant Utilisateur
======================================================

Module d'assistance utilisateur pour CESA v3.0.
...
class UserAssistant:
    """Assistant utilisateur pour CESA v3.0."""
    ...
    def show_welcome_assistant(self):
        ...
        welcome_window.title("🎉 Bienvenue dans CESA v3.0 - Assistant Personnalisé")
        ...
        esa_info_frame = ttk.LabelFrame(scrollable_frame, text="🧠 À Propos d'CESA v3.0", padding=15)
        esa_info_frame.pack(fill=tk.X, pady=(0, 15))
        
        esa_info_text = """
CESA (EEG Studio Analysis) v3.0 est une application professionnelle développée spécifiquement pour l'Unité 
...
• Monitoring en temps réel des signaux EEG
        ...
        features_frame = ttk.LabelFrame(scrollable_frame, text="🚀 Nouvelles Fonctionnalités v3.0", padding=15)
...
• Standards internationaux EEG (10-20, 10-10)
    ...
    def show_guided_tour(self):
        ...
        tour_window.title("🎯 Visite Guidée CESA v3.0")
        ...
        def next_step():
            if self.current_step < len(self.tour_steps) - 1:
                ...
                messagebox.showinfo("Visite terminée", 
                                  ...
                                  "Vous êtes maintenant prêt à utiliser CESA v3.0 !")
    ...
    def show_feature_explorer(self):
        ...
        explorer_window.title("🔍 Explorateur de Fonctionnalités CESA v3.0 - Guide Complet")
...
📋 DESCRIPTION
Cette fonctionnalité fait partie d'CESA v3.0 et contribue à l'analyse complète des signaux EEG.
...
Consultez le guide de référence complet pour les références scientifiques détaillées.
    ...
    def show_help_menu(self):
        ...
        help_window.title("❓ Aide CESA v3.0")
...
Licence : MIT
    ...
    def _open_reference_guide(self):
        ...
        reference_window.title("📚 Guide de Référence CESA v3.0")
...
1️⃣ README.md - Guide Principal :
   • Installation et configuration d'CESA v3.0
...
• Contactez le support avec des informations précises
    ...
    def _run_diagnostic(self):
        ...
        diagnostic_window.title("🔧 Diagnostic Système CESA v3.0")
