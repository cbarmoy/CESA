...
REM Version 0.0beta1.1

echo ========================================
echo  Initialisation Git et Push - CESA 0.0beta1.1
echo ========================================
echo.
...
git commit -m "chore: bump version to 0.0beta1.1

- Updated version number from 0.0alpha3.0 to 0.0beta1.1
...
echo   git tag -a v0.0beta1.1 -m "Release 0.0beta1.1"
echo   git push origin v0.0beta1.1
echo.
